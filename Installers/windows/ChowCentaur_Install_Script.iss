...
DefaultGroupName=ChowCentaur
OutputBaseFilename="ChowCentaur-Win-##APPVERSION##"
OutputDir=.
LicenseFile=../../LICENSE
...
[Files]
Source: "../../bin/Win64/ChowCentaur.vst3"; DestDir: "{code:GetDir|VST3_64}"; Components: VST3_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win64/ChowCentaur.dll"; Excludes: "*.vst3"; DestDir: "{code:GetDir|VST_64}"; Components: VST_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win32/ChowCentaur.vst3"; DestDir: "{code:GetDir|VST3_32}"; Components: VST3_32; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win32/ChowCentaur.dll"; Excludes: "*.vst3"; DestDir: "{code:GetDir|VST_32}"; Components: VST_32; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win64/ChowCentaur.exe"; Excludes: "*.vst3"; DestDir: "{code:GetDir|Standalone}"; Components: Standalone; Flags: ignoreversion recursesubdirs createallsubdirs
